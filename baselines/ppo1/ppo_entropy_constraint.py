...
def learn(env, policy_fn, *,
    ...
    meancent = tf.reduce_mean(ent-oldent)
    ...
    Hgrads = tf.gradients(dist, var_list)
    ...
    for shape in shapes:
        ...
        start += sz
    gvp = tf.add_n([tf.reduce_sum(g*tangent) for (g, tangent) in zipsame(Hgrads, tangents)]) #pylint: disable=E1111
