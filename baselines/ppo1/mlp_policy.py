...
import gym
from baselines.common.distributions import make_pdtype, BetaPdType
...
class MlpPolicy(object):
    ...
    # def _init(self, ob_name, ob_space, ac_space, hid_size, num_hid_layers, gaussian_fixed_var=True):
...
class MlpBetaPolicy(object):
    ...
    def _init(self, ob_space, ac_space, hid_size, num_hid_layers):
        ...
        stochastic = tf.placeholder(dtype=tf.bool, shape=())
        ac = tf.clip_by_value(self.pd.sample(), 1e-5, 1. - 1e-5)  # to prevent crashes when samples are 0. or 1.
        self._act = U.function([stochastic, ob], [ac, self.vpred])
