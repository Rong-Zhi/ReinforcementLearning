...
def control_arg_parser():
    ...
    parser.add_argument('--method', help='method', type=str, default='ppo-cnn-try')
    parser.add_argument('--policy_name', help='choose a policy net', type=str, default='cnnPolicy')
    parser.add_argument('--seed', help='RNG seed', type=int, default=0)
    ...
    parser.add_argument('--load_path', default='/home/zhi/Documents/share/LunarLanderContinuous-v2/ent-dynammic01-2l-2-05-23-11-51/checkpoints/00976')
