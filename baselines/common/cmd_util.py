...
def control_arg_parser():
    ...
    parser.add_argument('--net_size', help='Network size', default=[64],type=str2list)
    ...
    parser.add_argument('--load_path', default='/home/zhi/Documents/share/LunarLanderContinuousPOMDP-v0/clip-3l-hist0-bh17-0-05-22-01-22/checkpoints/00976')
